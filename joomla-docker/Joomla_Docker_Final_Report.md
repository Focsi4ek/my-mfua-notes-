...
![Параметры учетной записи](3.png)

### Настройка подключения к базе данных
При стандартной настройке подключения возникла ошибка `No such file or directory`, характерная для контейнеризированных приложений (попытка обращения к `localhost` вместо изолированного контейнера БД):

![Ошибка подключения к БД](4.png)
